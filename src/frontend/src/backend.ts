...
export class Backend implements backendInterface {
    ...
    async getAvailableSlots(): Promise<bigint> {
    ...
    async makeReservation(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async resetSlots(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetSlots(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
